...
#################################################################################
    ...
    graph_DPPNode += random.sample(link_DPPS["drug_chemical"], 10000)
    graph_DPPNode += random.sample(notLink_DPPS["drug_chemical"], 10000)
    graph_DPPNode += random.sample(link_DPPS["drug_sideeffects"], 10000)
    graph_DPPNode += random.sample(notLink_DPPS["drug_sideeffects"], 10000)
    graph_DPPNode += random.sample(link_DPPS["drug_substituent"], 10000)
    graph_DPPNode += random.sample(notLink_DPPS["drug_substituent"], 10000)
    graph_DPPNode += random.sample(link_DPPS["drug_target"], 10000)
    graph_DPPNode += random.sample(notLink_DPPS["drug_target"], 10000)
    graph_DPPNode += random.sample(link_DPPS["target_go"], 10000)
    graph_DPPNode += random.sample(notLink_DPPS["target_go"],10000)
    ...
    node_labels += [[1] for _ in range(10000)]
    node_labels += [[0] for _ in range(10000)]
    node_labels += [[1] for _ in range(10000)]
    node_labels += [[0] for _ in range(10000)]
    node_labels += [[1] for _ in range(10000)]
    node_labels += [[0] for _ in range(10000)]
        ...
        if i[1][0] == ("drug", "chemical"):
            ...
            for j in graph_DPPNode[:20000]:
                if i[1][1][0] == j[1][1][0]:
                        lis_link_source.append(i[0])
                        lis_link_sink.append(j[0])
            for j in graph_DPPNode[20000:40000]:
                if i[1][1][0] == j[1][1][0] or i[1][1][1] == j[1][1][1]:
                    if i[0] != j[0]:
                        lis_link_source.append(i[0])
                        lis_link_sink.append(j[0])
            for j in graph_DPPNode[40000:80000]:
                if i[1][1][0] == j[1][1][0]:
                        lis_link_source.append(i[0])
                        lis_link_sink.append(j[0])
        elif i[1][0] == ("drug", "substituent"):
            for j in graph_DPPNode[:40000]:
                if i[1][1][0] == j[1][1][0]:
                        lis_link_source.append(i[0])
                        lis_link_sink.append(j[0])
            for j in graph_DPPNode[40000:60000]:
                if i[1][1][0] == j[1][1][0] or i[1][1][1] == j[1][1][1]:
                    if i[0] != j[0]:
                        lis_link_source.append(i[0])
                        lis_link_sink.append(j[0])
            for j in graph_DPPNode[60000:80000]:
                if i[1][1][0] == j[1][1][0]:
                        lis_link_source.append(i[0])
                        lis_link_sink.append(j[0])
        elif i[1][0] == ("drug", "target"):
            for j in graph_DPPNode[:60000]:
                if i[1][1][0] == j[1][1][0]:
                        lis_link_source.append(i[0])
                        lis_link_sink.append(j[0])
            for j in graph_DPPNode[60000:80000]:
